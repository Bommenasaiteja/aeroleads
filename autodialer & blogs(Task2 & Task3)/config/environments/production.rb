...
Rails.application.configure do
  ...
  # Enable fallback to asset pipeline if a precompiled asset is missed (helpful for debugging)
  # In production, assets should be precompiled, but we'll allow fallback just in case
  ...
  # Railway handles SSL termination, so we can be flexible here
